...
export function buildSystem(
  ...
  const lines: string[] = [
    ...
    "An item may also have an `attribute` field — the name of the attribute whose value the source is (e.g. `aria-label`, `placeholder`, `title`, `alt`). Translate it as attribute text with that attribute's conventions, not as visible copy.",
