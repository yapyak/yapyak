...
- **Paranoid by default.** Missing values are caught as you type, every locale is checked on save, and the browser warns you in development. Over 40 numbered diagnostics, each with a page that explains the fix.
