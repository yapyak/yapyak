...
export function buildPrepaintScript(registry: OptionsRegistry): string {
  ...
  return [
    ...
    '});',
    'var rules = [];',
    "var shown = 'var(--prepaint-display,block) !important';",
    ...
    "  rules.push('[data-switch-group=\"' + gs + '\"] [data-when-value=\"' + vs + '\"]{display:' + shown + '}');",
    "  rules.push('[data-only-group=\"' + gs + '\"]:not([data-only-value=\"' + vs + '\"]){display:none !important}');",
    "  rules.push('[data-only-group=\"' + gs + '\"][data-only-value=\"' + vs + '\"]{display:' + shown + '}');",
    "  rules.push('[data-option-group=\"' + gs + '\"]:not([data-option-value=\"' + vs + '\"]){display:none !important}');",
    "  rules.push('[data-option-group=\"' + gs + '\"][data-option-value=\"' + vs + '\"]{display:' + shown + '}');",
    '});',
    'if (rules.length) {',
