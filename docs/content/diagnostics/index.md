...
Every diagnostic message includes a `See` URL pointing to its docs entry. The URL format is `https://yapyak.dev/reference/diagnostics/<code>` — `YAP0017` lives at `https://yapyak.dev/reference/diagnostics/YAP0017`, and so on. Click through (or hover in your editor) for the in-context explanation.
...
- [`YAP0039`](/reference/diagnostics/YAP0039) — Migration failed
...
- [`YAP0027`](/reference/diagnostics/YAP0027) — Locale listener threw
- [`YAP0030`](/reference/diagnostics/YAP0030) — Forced locale invalid
- [`YAP0040`](/reference/diagnostics/YAP0040) — Tracker threw
...
- [`YAP0025`](/reference/diagnostics/YAP0025) — Local-storage write failed
...
- [`YAP0033`](/reference/diagnostics/YAP0033) — Chunk failed
