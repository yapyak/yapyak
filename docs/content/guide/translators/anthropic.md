...
A full setup with voice and glossary:
...
For voice, glossary, context, batchSize, concurrency, and headers, see [the shared translator surface](/guide/translators/overview#what-every-translator-shares).
