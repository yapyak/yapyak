...
- A breaking change adds its entry to `BREAKING.md` under the version that ships it (the next patch) in the same change: before/after code and the migration steps.
